...
const create = async({ds_usuario, ds_senha, ds_email}) => {
    const query ={
        text:
        `INSERT INTO usuario (ds_usuario, ds_senha, ds_email)
        VALUES ($1, $2, $3)
        RETURNING ds_usuario, ds_senha, id_usuario
        `,
        values:[ds_usuario, ds_senha, ds_email]
    }
